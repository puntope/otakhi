...
class FacilitySeeder extends Seeder
{
    public function run()
    {
        $facilities = [ 'Internet' => 'This room has access to the shared WiFi in the house.', 'Private Bathroom' => 'The room provides its own private bathroom', 'Balcony' => 'The room has its own balcony', 'Heater' => 'The room counts with a heater', 'Private Kitchen' => 'THe room has its own private kitchen', 'Aircon' => 'The room provides air condition system' ];
